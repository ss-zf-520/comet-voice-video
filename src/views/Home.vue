<template>
    <div class="home">
        ...
        <div class="form-group">
            ...
            <div v-else>
                <button @click="startVideoChat" class="btn btn-secondary"> Start Call <span v-if="showSpinner"
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            // 方法还将CometChat.Call对象中可用的唯一会话ID作为参数。在startVideoChat（）方法之后立即添加此方法：
            acceptCall() {
        ...
        created() {
            // 一旦启动了呼叫，我们需要监听应用程序中的呼叫事件，并根据用户执行的接收或拒绝呼叫的操作，
            // 我们将调用适当的方法。要成功完成此操作，我们需要使用CometChat中的addCallListener（）
            // 方法注册CallListener侦听器。在created（）方法中添加以下内容：
            let globalContext = this;
